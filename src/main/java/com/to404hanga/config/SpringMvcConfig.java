...
import com.to404hanga.interceptor.ResourcesInterceptor;
...
//等同于<context:component-scan base-package="com.to404hanga.controller"/>
@ComponentScan({"com.to404hanga.controller"})
