...
<%--                        <li>--%>
<%--                            <a href="${pageContext.request.contextPath}/admin/book/search" target="iframe">--%>
<%--                                <i class="fa fa-circle-o"></i>图书借阅1--%>
<%--                            </a>--%>
<%--                        </li>--%>
<%--                        <li>--%>
<%--                            <a href="${pageContext.request.contextPath}/admin/book/searchBorrowed" target="iframe">--%>
<%--                                <i class="fa fa-circle-o"></i>当前借阅1--%>
<%--                            </a>--%>
<%--                        </li>--%>
<%--                        <li>--%>
<%--                            <a href="${pageContext.request.contextPath}/record/searchRecords" target="iframe">--%>
<%--                                <i class="fa fa-circle-o"></i>借阅记录1--%>
<%--                            </a>--%>
<%--                        </li>--%>
                        <li>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/book_borrowed.jsp" target="iframe">
            ...
            <div class="content-wrapper">
                <iframe width="100%" id="iframe" name="iframe" onload="SetIFrameHeight()" frameborder="0"
                    src="${pageContext.request.contextPath}/admin/book/selectNewbooks"></iframe>
            </div>
        </div>
    </body>
